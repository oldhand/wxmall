...
<div class="mui-off-canvas-wrap mui-draggable" id="offCanvasWrapper">
                    ...
                    <div class="mui-scroll">  
						<input id="page" value="1" type="hidden" > 
   		                 <div class="mui-table-view" >   
	   		                 		<input id="billwatershowmode" value="{$supplier_info.billwatershowmode}" type="hidden">
	...
	{literal}	 
		...
		function billwater_html(v) {	
			    var billwatershowmode =  Zepto('#billwatershowmode').val();  
				var sb=new StringBuilder();   
sb.append('			 <li class="mui-table-view-cell"> ');  
sb.append('				<div class="mui-media-body  mui-pull-left">');  
if (v.depositwatertype == 'returnmoney')
{
	sb.append('					<span style="width:105px;text-align:left;display:inline-block;">'+v.published+'</span>第'+v.returncount+'次'+v.depositwatertypeeinfo); 
} 
else
{
	sb.append('					<span style="width:105px;text-align:left;display:inline-block;">'+v.published+'</span>'+v.depositwatertypeeinfo);
}
sb.append('				</div>');  
sb.append('				<div class="mui-media-body mui-pull-right">');  
if (billwatershowmode == '0')
{
	sb.append('					'+v.flag+'&nbsp;<span class="price">¥'+v.amount+'</span>&nbsp;=&nbsp;¥'+v.remainmoney+'');  
} 
else
{
	sb.append('					'+v.flag+'&nbsp;<span class="price">¥'+v.amount+'</span>');  
}
