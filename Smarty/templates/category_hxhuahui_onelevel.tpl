...
<head>
	...
	{if $supplier_info.themecolor neq ''}
		...
		<!--
			...
			{/if}
			.menuitem-color {ldelim}  background-color: {$supplier_info.themecolor};  {rdelim} 
			...
			{include file='footer.tpl'}   
             <div id="pullrefresh" class="mui-content mui-scroll-wrapper" style="padding-top: 80px;"> 
                 <div class="mui-scroll" >   
						 ...
						 <div class="mui-table-view" style="background-color: #fff;"> 
	 							 <ul id="categorys_list" class="mui-table-view" >
				                    {foreach name="categorys" from=$categorys item=v key=k}
									    {if $categoryid eq $v.id}
			 								<li class="categorys mui-table-view-cell mui-pull-left menuitem-color" style="width:80px;">
			 									<a  data-id="{$v.id}" href="javascript:;">
			 										 <div class="mui-media-body" style="text-align: center;">{$v.name}</div>
			 									</a>
			 								</li> 
										{else}
			 								<li class="categorys mui-table-view-cell mui-pull-left" style="width:80px;">
			 									<a  data-id="{$v.id}" href="javascript:;">
			 										 <div class="mui-media-body" style="text-align: center;">{$v.name}</div>
			 									</a>
			 								</li>
						 ...
						 <div style="clear:both;"></div> 
	                      <ul id="list" class="mui-table-view list">
 							 <div class="mui-table-view-cell" style="padding: 0px;"> 
								{if $supplier_info.categoryscolumns eq '2'}
...
function category_html(v,categoryscolumns) { 
   		  ...
   		  if (categoryscolumns == "2")
   		  {
				 ...
				 sb.append('            <img id="product_item_'+v.productid+'" class="img-responsive" src="images/lazyload.png" data-lazyload="'+v.productlogo+'">');
  ...
  function product_singlerow_classic_html(v) { 
	   var sb=new StringBuilder();
		 ...
		 { 
			 ...
			 sb.append('        <img class="mui-media-object mui-pull-left" id="product_item_'+v.productid+'" src="images/lazyload.png" data-lazyload="'+v.productthumbnail+'">');
		 ...
		 else
		 {
			  sb.append('<a class="mui-navigate-right" href="javascript:;">');
	 		  sb.append('       <img data-url="detail.php?from=index&productid='+v.productid+'" class="mui-media-object mui-pull-left detailimage" id="product_item_'+v.productid+'" src="images/lazyload.png" data-lazyload="'+v.productlogo+'">');
 ...
 function product_singlerow_html(v) { 
	 var sb=new StringBuilder();
		 sb.append('<li class="mui-table-view-cell mui-media singlerow" style="width:100%">');
 		 sb.append('<a href="detail.php?from=index&productid='+v.productid+'">');
		 sb.append('	 <img style="width:100%;height:auto;max-width:100%;" id="product_item_'+v.productid+'" class="mui-media-object img-responsive"  src="images/lazyload.png" data-lazyload="'+v.productlogo+'">');
 		 sb.append('</a>');
	...
	mui.ready(function() {  
		...
		mui('#categorys_list').on('tap', 'a', function(e) {
			...
			Zepto(".categorys").removeClass("menuitem-color");  
			Zepto(this).parent().addClass("menuitem-color");  
