			...
			<header class="mui-bar mui-bar-nav" style="padding-right: 15px;background-color:#fff">   
                 <div class="mui-title mui-content tit-sortbar" id="sortbar" style="margin-top: 0px;"> 
		 				<div id="segmentedControl" class="mui-segmented-control mui-segmented-control-inverted mui-segmented-control-negative">
							...
							<a class="mui-control-item mui-active" href="rankwaters.php">积分流水</a> 
							{/if}
		 				</div> 
                 </div>
			</header>
...
sb.append('					<span style="width:105px;text-align:left;display:inline-block;">'+v.published+'</span>'+v.rankwatertypeinfo);  
sb.append('				</div>');  
sb.append('				<div class="mui-media-body mui-pull-right">'); 
if (billwatershowmode == '0')
{
	sb.append('					'+v.flag+'&nbsp;<span class="price">'+v.amount+'</span>&nbsp;=&nbsp;'+v.rank+''); 
} 
else
{
...
sb.append('					      <p class="msgbody">您的积分流水还是空的，快去选购商品吧<br>'); 
