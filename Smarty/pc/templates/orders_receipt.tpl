          ...
          <div class="person-dj border bn">
            <div class="person-post-tit person-linetit">
              ...
              <ul class="pull-left">
                ...
                <li><a href="orders_receipt.php" class="active">待收货</a>|</li>
...
//分页查询 
  ...
  function product_html(v) { 
    ...
    {
      sb.append('<td width="11%"><p class="mb-5"><a href="javascript:;" class="btn btn-danger btn-sm btn-p10 confirmreceipt" data-id="' + v.orderid + '">确认收货</a></p>');
    }
    else
    {
      sb.append('<td width="11%"><p class="mb-5"><a href="javascript:;" class="btn btn-danger btn-sm btn-p10">等待商家发货</a></p>');
    }
