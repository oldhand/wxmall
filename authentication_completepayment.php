...
$authenticationorderid = $_REQUEST['authenticationorderid'];
$smarty->assign("authenticationorderid",$authenticationorderid); 

$authenticationorder_info = XN_Content::load($authenticationorderid,'supplier_authenticationorders');

$smarty->assign("rankname",$authenticationorder_info->my->rankname); 
$smarty->assign("amount",$authenticationorder_info->my->amount); 
